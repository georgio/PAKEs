use spake2r::{prover::Prover, verifier::Verifier, Ed25519Group, Error, Identity, Password};

#[test]
fn test_basic() {
    let (s1, msg1) = Prover::<Ed25519Group>::start(
        &Password::new(b"password"),
        &Identity::new(b"idProver"),
        &Identity::new(b"idVerifier"),
    );
    let (s2, msg2) = Verifier::<Ed25519Group>::start(
        &Password::new(b"password"),
        &Identity::new(b"idProver"),
        &Identity::new(b"idVerifier"),
    );
